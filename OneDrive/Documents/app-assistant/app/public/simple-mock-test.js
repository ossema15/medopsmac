// Simple Mock Test - Paste this directly into console
console.log('🚀 SIMPLE MOCK TEST STARTING...');
...
function addMockPatient() {
  ...
  logEvent('MOCK_PATIENT_ADDED');
  
  return true;
}

async function runSimpleMockTest() {
  console.log('📋 Starting simple mock test...');
  ...
  if (patientAdded) {
    ...
    if (deleteButton) {
      ...
      logEvent('STEP_3', 'No delete button found');
    }
  }
...
// Auto-start
console.log('🤖 Simple mock test will start in 2 seconds...');
setTimeout(runSimpleMockTest, 2000);

// Export for manual execution
window.runSimpleMockTest = runSimpleMockTest; 